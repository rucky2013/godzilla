                ...
                <thead>
                 ...
                 <#list userAuthList as uas>
                  <tr>
                    ...
                    <td class="sp" width="8%"><a id="add_btn" href="javascript:void(0);" value1="${uas.username}"><span class="edit">添加用户</span></a></td>
                    <td class="sp02" width="8%"><a id="edit_btn" href="javascript:void(0);" value1="${uas.username}"><span class="edit">编辑工作台</span></a></td>
                  </tr>
                  </#list>
                  </tbody>
                </table>
