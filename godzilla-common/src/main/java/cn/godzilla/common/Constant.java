...
public interface Constant {
	...
	public final String SH_RESTARTTOMCAT_CLIENT = "sh /home/godzilla/gzl/shell/client/restart_client.sh";
	public final String SH_GODZILLA_SERVER = "sh /home/godzilla/gzl/shell/server/godzilla.sh";
	public final String SH_MVN_CLIENT = "sh /home/godzilla/gzl/shell/client/godzilla_mvn.sh";
	...
	public final String COM_INFO = "INFO";
	...
	public final static String NO_AJAX = "NO_AJAX";
	public final static String NULL_NAMEPASSWORD = "NULL_NAMEPASSWORD";
	public final static String NOTEXIST_USER = "NOTEXIST_USER";
	public final static String WRONG_PASSWORD = "WRONG_PASSWORD";
	public final static String UNKNOW_ERROR = "UNKNOW_ERROR";
	public final static String NO_LOGIN = "NO_LOGIN";
	public final static String NO_ADDUPDATEPROP = "NO_ADDUPDATEPROP";
	public final static String NO_VERIFYPROP = "NO_VERIFYPROP";
	public final static String NO_AUTHORITY = "NO_AUTHORITY";
	//public final static String NO_MVNDEPLOY = "NO_MVNDEPLOY";
	public final static String NO_CHANGEPOM = "NO_CHANGEPOM";
	public final static String NO_RPCFACTORY = "NO_RPCFACTORY";
	public final static String NO_AUTHORIZATION = "NO_AUTHORIZATION";
	public final static String NO_ADDUSER = "NO_ADDUSER";
	public final static String NO_SAMEPASSWORD = "NO_SAMEPASSWORD";
	public final static String NO_UPDATEFUNRIGHT = "NO_UPDATEFUNRIGHT";
	public final static String NO_CHANGECOMMIT = "NO_CHANGECOMMIT";
	public final static String NO_SVNCOMMIT = "NO_SVNCOMMIT";
	public final static String NO_FOUNDCONFLICT = "NO_FOUNDCONFLICT";
	public final static String NO_CLIENTPARAM = "NO_CLIENTPARAM";
	public final static String NO_SERVERPARAM = "NO_SERVERPARAM";
	public final static String NO_JAVASHELLCALL = "NO_JAVASHELLCALL";
	public final static String NO_SVNVERSION = "NO_SVNVERSION";
	public final static String NO_GODZILLA = "NO_GODZILLA";
	public final static String NO_DELETEBRANCH = "NO_DELETEBRANCH";
	public final static String NO_SVNMERGE = "NO_SVNMERGE";
	public final static String NO_MVNBUILD = "NO_MVNBUILD";
	public final static String NO_COMMON = "NO_COMMON";
	public final static String NO_CONCURRENCEDEPLOY = "NO_CONCURRENCEDEPLOY";
	public final static String NO_MVNSETPROPS = "NO_MVNSETPROPS";
	public final static String NO_HASKEYDEPLOY = "NO_HASKEYDEPLOY";
	public final static String NO_EXISTUSER = "NO_EXISTUSER";
	public final static String NO_STARTTOMCAT = "NO_STARTTOMCAT";
	public final static String NO_SRCEDIT = "NO_SRCEDIT";
	public final static String NO_BRANCHADD = "NO_BRANCHADD";
	public final static String NO_SVNSTATUS = "NO_SVNSTATUS";
	public final static String NO_SHOWWARINFO = "NO_SHOWWARINFO";
	public final static String NO_SHOWDEPLOYLOG = "NO_SHOWDEPLOYLOG";
	public final static String NO_RESTARTTOMCAT = "NO_RESTARTTOMCAT";
	public final static String NO_MVNBUILDLOG = "NO_MVNBUILDLOG";
	public final static String NO_DEPLOYLOGID = "NO_DEPLOYLOGID";
	public final static String NO_STOREDEPLOYLOG = "NO_STOREDEPLOYLOG";
	public final static String NO_SHOWWARINFOID = "NO_SHOWWARINFOID";
	public final static String NO_RESTARTEFFECT = "NO_RESTARTEFFECT";
	public final static String NO_INTERRUPTEDEX = "NO_INTERRUPTEDEX";
	public final static String NO_SYSTEMEX = "NO_SYSTEMEX";
	public final static String NO_RPCEX = "NO_RPCEX";
	public final static String NO_SVNEDIT = "NO_SVNEDIT";
	public final static String NO_EDITMERGESTATUS = "NO_EDITMERGESTATUS";
	public final static String NO_SVNRESOLVED = "NO_SVNRESOLVED";
	public final static String NO_ERRORCOMMAND = "NO_ERRORCOMMAND";
	public final static String NO_STILLHASCONFLICTBRANCH = "NO_STILLHASCONFLICTBRANCH";
	public final static String NO_HAVEBRANCHES = "NO_HAVEBRANCHES";
	public final static String NO_FOUNDNEWCONFLICT = "NO_FOUNDNEWCONFLICT";
	public final static String NO_SVNRESOLVE = "NO_SVNRESOLVE";
	public final static String NO_NEWCONFLICTFOUND = "NO_NEWCONFLICTFOUND";
	public final static String NO_WRONGOLDPWD = "NO_WRONGOLDPWD";
	public final static String NO_CHANGEPWD = "NO_CHANGEPWD";
	public final static String NO_LOOSEPROP = "NO_LOOSEPROP";
	public final static String NO_NEEDRESOLVE = "NO_NEEDRESOLVE";
	
	public final static String OK_AJAX = "OK_AJAX";
	public final static String OK_CHECKUSER = "OK_CHECKUSER";
	public final static String OK_LOGIN = "OK_LOGIN";
	public final static String OK_ADDUPDATEPROP = "OK_ADDUPDATEPROP";
	public final static String OK_VERIFYPROP = "OK_VERIFYPROP";
	public final static String OK_MVNDEPLOY = "OK_MVNDEPLOY";
	public final static String OK_CHANGEPOM = "OK_CHANGEPOM";
	public final static String OK_AUTHORIZATION = "OK_AUTHORIZATION";
	public final static String OK_ADDUSER = "OK_ADDUSER";
	public final static String OK_UPDATEFUNRIGHT = "OK_SVNCOMMIT";
	public final static String OK_SVNCOMMIT = "OK_SVNCOMMIT";
	public final static String OK_SVNVERSION = "OK_SVNVERSION";
	public final static String OK_SORTPROP = "OK_SORTPROP";
	public final static String OK_GODZILLA = "OK_GODZILLA";
	public final static String OK_DELETEBRANCH = "OK_DELETEBRANCH";
	public final static String OK_SVNMERGE = "OK_SVNMERGE";
	public final static String OK_MVNBUILD = "OK_MVNBUILD";
	public final static String OK_STARTTOMCAT = "OK_STARTTOMCAT";
	public final static String OK_SRCEDIT = "OK_SRCEDIT";
	public final static String OK_BRANCHADD = "OK_BRANCHADD";
	public final static String OK_SVNSTATUS = "OK_SVNSTATUS";
	public final static String OK_SHOWWARINFO = "OK_SHOWWARINFO";
	public final static String OK_SHOWDEPLOYLOG = "OK_SHOWDEPLOYLOG";
	public final static String OK_QUERYPERCENT = "OK_QUERYPERCENT";
	public final static String OK_SVNEDIT = "OK_SVNEDIT";
	public final static String OK_EDITMERGESTATUS = "OK_EDITMERGESTATUS";
	public final static String OK_SVNRESOLVED = "OK_SVNRESOLVED";
	public final static String OK_CHANGEPWD = "OK_CHANGEPWD";
